...
{
  let debug_lexer = Option.is_some (Sys.getenv_opt "DEBUG_LEXER")
  ...
  let token lexbuf =
    ...
    if debug_lexer then (
      let text = match result with
        ...
        | HASH                   -> "HASH"
        | HASH_FLOAT _           -> "HASH_FLOAT _"
        | HASH_INT _             -> "HASH_INT _"
        ...
        | IN                     -> "IN"
        | INCLUDE                -> "INCLUDE"
        | INFIXOP0 _             -> "INFIXOP0 _"
        | INFIXOP1 _             -> "INFIXOP1 _"
        | INFIXOP2 _             -> "INFIXOP2 _"
        | INFIXOP3 _             -> "INFIXOP3 _"
        | INFIXOP4 _             -> "INFIXOP4 _"
        | INHERIT                -> "INHERIT"
        | INITIALIZER            -> "INITIALIZER"
        | INT _                  -> "INT _"
        ...
        | OF                     -> "OF"
        | OPEN                   -> "OPEN"
        | OPTLABEL _             -> "OPTLABEL _"
        | OR                     -> "OR"
        | PERCENT                -> "PERCENT"
        | PLUS                   -> "PLUS"
        | PLUSDOT                -> "PLUSDOT"
        | PLUSEQ                 -> "PLUSEQ"
        | PREFIXOP _             -> "PREFIXOP _"
        | PRIVATE                -> "PRIVATE"
        | QUESTION               -> "QUESTION"
        | QUOTE                  -> "QUOTE"
        | QUOTED_STRING_EXPR _   -> "QUOTED_STRING_EXPR _"
        | QUOTED_STRING_ITEM _   -> "QUOTED_STRING_ITEM _"
        | RBRACE                 -> "RBRACE"
        | RBRACKET               -> "RBRACKET"
        | REC                    -> "REC"
        | RPAREN                 -> "RPAREN"
        ...
        | TRY                    -> "TRY"
        | TYPE                   -> "TYPE"
        | TYPE_DISAMBIGUATOR _   -> "TYPE_DISAMBIGUATOR _"
        | UIDENT _               -> "UIDENT _"
